                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="#" class="image">
                                                ...
                                                <img class="hover-image" src="{{ asset('storage/' . json_decode($product->images)[1]) }}" alt="{{ $product->name }}" />
                                            </a>
                                        ...
                                        <div class="content">
                                            ...
                                            <h5 class="title"><a href="#">{{ $product->meta_title }}</a></h5>
                                            <span class="price">
            ...
            <div class="row">
                <div class="col">
                    <div class="tab-content top-borber">
                        ...
                        <!-- Trending tab -->
                        <div class="tab-pane fade show" id="tab-product-trending">
                            <div class="new-product-slider swiper-container slider-nav-style-1 small-nav">
                                <div class="new-product-wrapper swiper-wrapper">
                        ...
                        <!-- Popular tab start -->
                        <div class="tab-pane fade show" id="tab-product-popular">
                            <div class="new-product-slider swiper-container slider-nav-style-1 small-nav">
                                <div class="new-product-wrapper swiper-wrapper">
